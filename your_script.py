...
if st.button("Predict"):
    ...
    st.write(f"**Predicted Label**: {predicted_class} (0: grade1,1: grade2-3)")
    ...
    # shap_values_numpy = explainer.shap_values(pd.DataFrame([feature_values], columns=feature_names))
    # # 绘制单个样本的 SHAP 力图
    ...
    # shap.force_plot(explainer.expected_value[sample_index], shap_values_numpy[sample_index], X_test.iloc[sample_index], matplotlib=True,show=False)
