...
if st.button("Predict"):
    ...
    shap.force_plot(explainer.expected_value[sample_index], shap_values_numpy[sample_index], pd.DataFrame([feature_values], columns=feature_names), matplotlib=True,show=True)
